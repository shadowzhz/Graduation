...
def _apply_responsive_layout(root):
    ...
    global GOAL_DEPTH, STONE_RADIUS, MALLET_RADIUS, GOAL_POST_RADIUS, GOAL_POSTS
    global PLAYER_MAX_SPEED, MAX_STONE_SPEED, STONE_FRICTION_DECELERATION
    global STONE_STOP_SPEED, MIN_WALL_BOUNCE_SPEED, STONE_RESPONSE_ACCELERATION
    global DIFFICULTIES
    ...
    MAX_STONE_SPEED = 1_100.0 * UI_SCALE
    STONE_FRICTION_DECELERATION = 72.0 * UI_SCALE
    STONE_STOP_SPEED = 8.0 * UI_SCALE
    MIN_WALL_BOUNCE_SPEED = 96.0 * UI_SCALE
    STONE_RESPONSE_ACCELERATION = 9_000.0 * UI_SCALE
    DIFFICULTIES = build_difficulties(UI_SCALE)
